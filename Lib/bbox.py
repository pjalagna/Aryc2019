...
#file bbox.py
#generated for bbox.basii at Fri Mar  6 17:56:10 2020 
...
def Ver_1():
    ...
    logg("""bbox version 3.6.20""")
    if (r == p['OK']):
        logg('push text ' + """bbox version 3.6.20""")
        datPush("bbox version 3.6.20")
        logg('after ' + """bbox version 3.6.20""" )
        datPush(p['OK'])
    else:
        logg('text skipped')
        p['sy']['push'](r) # pass nok to next
...
def b2_3():
    ...
    r = p['sy']['pop']()
    logg('for b2-3 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
...
def b2_4():
    ...
    r = p['sy']['pop']()
    logg('for b2-4 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
...
def b2_5():
    ...
    r = p['sy']['pop']()
    logg('for b2-5 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
    ...
    r = p['sy']['pop']()
    logg('for b2-5 processing verb ( drop ) ')
    if (r == p['OK']):
        logg('call drop ')
        p['sy']['drop'](p)
        logg('after drop')
...
def b2_6():
    ...
    r = p['sy']['pop']()
    logg('for b2-6 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
    ...
    r = p['sy']['pop']()
    logg('for b2-6 processing verb ( drop ) ')
    if (r == p['OK']):
        logg('call drop ')
        p['sy']['drop'](p)
        logg('after drop')
...
def b2_7():
    ...
    r = p['sy']['pop']()
    logg('for b2-7 processing verb ( .X ) ')
    if (r == p['OK']):
        logg('call .X ')
        p['sy']['.X'](p)
        logg('after .X')
...
def b2_8():
    ...
    r = p['sy']['pop']()
    logg('for b2-8 processing verb ( msg ) ')
    if (r == p['OK']):
        logg('call msg ')
        p['sy']['msg'](p)
        logg('after msg')
