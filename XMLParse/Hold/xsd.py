...
#file xsd.py
#generated for xsdP3.basii at Fri Apr 10 18:58:48 2020 
...
def xsdVersion_1():
    ...
    logg("""version 4-10-20..1810""")
    if (r == p['OK']):
        logg('push text ' + """version 4-10-20..1810""")
        datPush("version 4-10-20..1810")
        logg('after ' + """version 4-10-20..1810""" )
        datPush(p['OK'])
    else:
        logg('text skipped')
...
def xsdmain_1():
    ...
    r = p['sy']['pop']()
    logg('for xsdmain-1 processing verb ( xsdVersion ) ')
    if (r == p['OK']):
    ...
    r = p['sy']['pop']()
    logg('for xsdmain-1 processing verb ( p1 ) ')
    if (r == p['OK']):
        logg('call p1 ')
        p['sy']['p1'](p)
        logg('after p1')
...
def xsdInit_1():
    ...
    logg("""xsdInit begin""")
    if (r == p['OK']):
        logg('push text ' + """xsdInit begin""")
        datPush("xsdInit begin")
        logg('after ' + """xsdInit begin""" )
        datPush(p['OK'])
    else:
        logg('text skipped')
        p['sy']['push'](r) # pass nok to next
    ...
    r = p['sy']['pop']()
    logg('for xsdInit-1 processing verb ( msg ) ')
    if (r == p['OK']):
        logg('call msg ')
        p['sy']['msg'](p)
        logg('after msg')
    ...
    r = p['sy']['pop']()
    logg('for xsdInit-1 processing verb ( parentPlus ) ')
    if (r == p['OK']):
        logg('call parentPlus ')
        p['sy']['parentPlus'](p)
...
def p1_1():
    ...
    r = p['sy']['pop']()
    logg('for p1-1 processing verb ( msg ) ')
    if (r == p['OK']):
        logg('call msg ')
        p['sy']['msg'](p)
        logg('after msg')
    ...
    r = p['sy']['pop']()
    logg('for p1-1 processing verb ( f@ ) ')
    if (r == p['OK']):
        logg('call f@ ')
        p['sy']['f@'](p)
        logg('after f@')
    ...
    r = p['sy']['pop']()
    logg('for p1-1 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
    ...
    r = p['sy']['pop']()
    logg('for p1-1 processing verb ( clipt ) ')
    if (r == p['OK']):
        logg('call clipt ')
        p['sy']['clipt'](p)
        logg('after clipt')
    ...
    r = p['sy']['pop']()
    logg('for p1-1 processing verb ( p2 ) ')
    if (r == p['OK']):
        logg('call p2 ')
        p['sy']['p2'](p)
        logg('after p2')
...
def p2_1():
    ...
    r = p['sy']['pop']()
    logg('for p2-1 processing text ')
    logg("""p2 begin""")
    if (r == p['OK']):
        logg('push text ' + """p2 begin""")
        datPush("p2 begin")
        logg('after ' + """p2 begin""" )
        datPush(p['OK'])
    else:
    ...
    r = p['sy']['pop']()
    logg('for p2-1 processing verb ( msg ) ')
    if (r == p['OK']):
        logg('call msg ')
        p['sy']['msg'](p)
        logg('after msg')
    ...
    r = p['sy']['pop']()
    logg('for p2-1 processing verb ( p2a ) ')
    if (r == p['OK']):
        logg('call p2a ')
        p['sy']['p2a'](p)
        logg('after p2a')
...
def p2 (x):
    ...
    logg('begin p2')
    ## point of umbrella
    p2Ctl = 1 # starting spoke
    while p2Ctl != 0:
        logg('loop p2Ctl = ' + p2Ctl.__str__())
        if (p2Ctl == -1):
            nop = -1 # false test to set up elif chain
...
def p2a_1():
    ...
    r = p['sy']['pop']()
    logg('for p2a-1 processing text ')
    logg("""p2a begin""")
    if (r == p['OK']):
        logg('push text ' + """p2a begin""")
        datPush("p2a begin")
        logg('after ' + """p2a begin""" )
        datPush(p['OK'])
    else:
        logg('text skipped')
        p['sy']['push'](r) # pass nok to next
    ...
    r = p['sy']['pop']()
    logg('for p2a-1 processing verb ( msg ) ')
    if (r == p['OK']):
        logg('call msg ')
        p['sy']['msg'](p)
        logg('after msg')
    ...
    r = p['sy']['pop']()
    logg('for p2a-1 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
    ...
    r = p['sy']['pop']()
    logg('for p2a-1 processing verb ( find ) ')
    if (r == p['OK']):
        logg('call find ')
        p['sy']['find'](p)
        logg('after find')
    ...
    r = p['sy']['pop']()
    logg('for p2a-1 processing verb ( cut ) ')
    if (r == p['OK']):
        logg('call cut ')
        p['sy']['cut'](p)
        logg('after cut')
    ...
    r = p['sy']['pop']()
    logg('for p2a-1 processing verb ( ! ) ')
    if (r == p['OK']):
        logg('call ! ')
        p['sy']['!'](p)
        logg('after !')
    ...
    r = p['sy']['pop']()
    logg('for p2a-1 processing verb ( drop ) ')
    if (r == p['OK']):
        logg('call drop ')
        p['sy']['drop'](p)
        logg('after drop')
...
def p2a (x):
    ...
    logg('begin p2a')
    ## point of umbrella
    p2aCtl = 1 # starting spoke
    while p2aCtl != 0:
        logg('loop p2aCtl = ' + p2aCtl.__str__())
        if (p2aCtl == -1):
            nop = -1 # false test to set up elif chain
...
def clipt_1():
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing text ')
    logg("""clipt begin""")
    if (r == p['OK']):
        logg('push text ' + """clipt begin""")
        datPush("clipt begin")
        logg('after ' + """clipt begin""" )
        datPush(p['OK'])
    else:
        logg('text skipped')
        p['sy']['push'](r) # pass nok to next
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing verb ( msg ) ')
    if (r == p['OK']):
        logg('call msg ')
        p['sy']['msg'](p)
        logg('after msg')
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing verb ( pick ) ')
    if (r == p['OK']):
        logg('call pick ')
        p['sy']['pick'](p)
        logg('after pick')
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing verb ( swap ) ')
    if (r == p['OK']):
        logg('call swap ')
        p['sy']['swap'](p)
        logg('after swap')
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing verb ( find ) ')
    if (r == p['OK']):
        logg('call find ')
        p['sy']['find'](p)
        logg('after find')
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing verb ( - ) ')
    if (r == p['OK']):
        logg('call - ')
        p['sy']['-'](p)
        logg('after -')
    ...
    r = p['sy']['pop']()
    logg('for clipt-1 processing verb ( cut ) ')
    if (r == p['OK']):
        logg('call cut ')
        p['sy']['cut'](p)
        logg('after cut')
...
def clipt (x):
    ...
    logg('begin clipt')
    ## point of umbrella
    cliptCtl = 1 # starting spoke
    while cliptCtl != 0:
        logg('loop cliptCtl = ' + cliptCtl.__str__())
        if (cliptCtl == -1):
            nop = -1 # false test to set up elif chain
            ...
            logg('call clipt_1')
            clipt_1()
            logg('after call clipt_1')
            # test and adjust for new spoke
            cliptCtl = chk(cliptCtl)
...
def parentPlus_1():
    ...
    logg("""parents plus begin""")
    if (r == p['OK']):
        logg('push text ' + """parents plus begin""")
        datPush("parents plus begin")
        logg('after ' + """parents plus begin""" )
        datPush(p['OK'])
    else:
        logg('text skipped')
        p['sy']['push'](r) # pass nok to next
    ...
    r = p['sy']['pop']()
    logg('for parentPlus-1 processing verb ( msg ) ')
    if (r == p['OK']):
        logg('call msg ')
        p['sy']['msg'](p)
        logg('after msg')
    ...
    r = p['sy']['pop']()
    logg('for parentPlus-1 processing verb ( dup ) ')
    if (r == p['OK']):
        logg('call dup ')
        p['sy']['dup'](p)
        logg('after dup')
    ...
    r = p['sy']['pop']()
    logg('for parentPlus-1 processing verb ( swap ) ')
    if (r == p['OK']):
        logg('call swap ')
        p['sy']['swap'](p)
        logg('after swap')
