...
#
def xInit():
    global s,pu,fsz,ftsw,cnxftsw,sequenceMode,chooseMode,elementHold,elementHoldPU,seq
    seq = 0
    elementHold=0
    elementHoldPU = 0
    sequenceMode = 0
...
#
def spoP():
    global cnx,attr,pu,kri,nax,r1,l2x
    print('--spoP')
    # best kri 
    #add cnx to parents
    parentPlus(cnx)
...
#
def spoAttr():
    global cnx,attr,pu,kri,parent,parentKRI,s,cnxftsw
    print('--spoAttr')
    #attributes spo
    ...
    puat = parentPU[len(parentPU)-2]
    puat = puat.__str__()
    spoPlus(kri,'parentPickup',puat) 
